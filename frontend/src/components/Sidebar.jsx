  ...
  return (
    <aside className="flex h-screen w-80 flex-col border-r border-zinc-900 bg-zinc-950/95 backdrop-blur-xl p-5 select-none">
      ...
      <button
        ...
        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white px-4 py-2.5 text-sm font-semibold border border-zinc-700 shadow-lg transition-all duration-200 active:scale-[0.98]"
      >
      ...
      <div className="mt-4 relative">
        ...
        />
        <svg
          className="w-3.5 h-3.5 text-zinc-500 absolute left-3 top-3"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
// React.memo ensures typing in the editor won't re-render the sidebar unless notes or selectedNoteId change
